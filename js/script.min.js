...
module.exports = {"app":"app___2khK2","vis_container":"vis_container___1WzZz","question_container":"question_container___wVFm0","answer_yes":"answer_yes___19y9u","answer_no":"answer_no___3Cq15","no_answer":"no_answer___2wO5C","flag_container":"flag_container___3VMxB","clearfix":"clearfix___1yHqr","ss-terms":"ss-terms___dMEZ6","meta":"meta___3gcNx","clear_both":"clear_both___a0DL_","hidden":"hidden___1aMNf","nowrap":"nowrap___2n1o8"};
...
var App_App = function App() {
  ...
  var cleanData = function cleanData(json_data) {
    ...
    json_data.forEach(function (el) {
      Object.keys(tmp_data).forEach(function (question) {
  ...
  var createVis = function createVis(container) {
    ...
    var vis_container = src_select('.' + container);
    [styles_default.a.answer_yes, styles_default.a.answer_no, styles_default.a.no_answer].forEach(function (el) {
      vis_container.selectAll('.' + el + ' img').style('opacity', 0).style('height', 0).style('width', 0).transition().duration(500).delay(function (d, i) {
        return 30 * i;
  ...
  return /*#__PURE__*/react_default.a.createElement("div", {
  ...
  }, data && Object.keys(data).map(function (question, i) {
    return /*#__PURE__*/react_default.a.createElement("div", {
      key: question,
      className: 'question_' + i + ' ' + styles_default.a.question_container
    }, /*#__PURE__*/react_default.a.createElement("h3", null, question), /*#__PURE__*/react_default.a.createElement(lib_default.a, {
      once: true
    }, function (isVisible) {
      return /*#__PURE__*/react_default.a.createElement("div", {
        className: styles_default.a.answer_yes
      }, isVisible && createVis('question_' + i), /*#__PURE__*/react_default.a.createElement("h4", null, "Yes, ", data[question].filter(function (el) {
        return el.answer === 1;
      }).length, " countries"), data[question].map(function (el, j) {
        if (el.answer === 1) {
          return /*#__PURE__*/react_default.a.createElement("div", {
            className: styles_default.a.flag_container,
            key: i + '_' + j,
            "data-tip": el.country
    ...
    }, /*#__PURE__*/react_default.a.createElement("h4", null, "No, ", data[question].filter(function (el) {
      return el.answer === 0;
    }).length, " countries"), data[question].map(function (el, j) {
      if (el.answer === 0) {
        return /*#__PURE__*/react_default.a.createElement("div", {
    ...
    }, /*#__PURE__*/react_default.a.createElement("h4", null, "No answer, ", data[question].filter(function (el) {
